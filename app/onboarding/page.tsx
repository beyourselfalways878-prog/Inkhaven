    ...
    <div className="container mx-auto px-6 py-10">
      <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] items-start">
        <section className="card p-6">
          ...
          <h2 className="mt-4 text-3xl font-semibold text-white text-white">Create your anonymous profile</h2>
          <p className="mt-3 text-sm text-slate-500 text-white/50">
          ...
          <div className="mt-6 space-y-3">
            {steps.map((item) => {
              ...
              return (
                <div key={item.title} className="flex items-start gap-3 rounded-xl border border-slate-200 border-white/5 bg-slate-950/60 backdrop-blur-3xl border border-white/20 bg-slate-900 text-white/[0.03] px-4 py-3">
                  <div className="h-8 w-8 rounded-full bg-teal-500/20 text-teal-400 flex items-center justify-center text-xs font-semibold shrink-0">
                    <Icon size={16} />
                  </div>
                  <div>
        ...
        <section className="glass p-6">
          <div className="card p-6 border-slate-200 border-white/5 bg-slate-900 text-white bg-obsidian-900/50 relative overflow-hidden">
            {/* Background ambient glow matching the potential aura */}
            <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-teal-500/10 to-transparent pointer-events-none" />

            <div className="flex items-center justify-between relative z-10">
              <h3 className="text-lg font-semibold text-white text-white">Your profile</h3>
              <span className="text-xs text-teal-400 font-medium tracking-wide">InkHaven Identity</span>
            </div>
            ...
            <div className="mt-8 mb-6 flex flex-col items-center justify-center relative z-10">
              ...
              <div className="mt-4 text-center">
                <p className="text-sm font-medium text-slate-700 text-white/90 font-mono tracking-wider">PREVIEW AURA</p>
                <p className="text-xs text-slate-400 text-white/40 mt-1">This will adapt to your unique energy.</p>
              </div>
            </div>
