    ...
    return (
        <div className="container mx-auto px-6 py-12 max-w-4xl">
            <div className="prose prose-slate max-w-none">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-teal-50 from-blue-950/30 to-teal-950/30 rounded-2xl p-6 mb-8">
                ...
                <section className="mb-10">
                    ...
                    <div className="bg-slate-950/40 backdrop-blur-2xl border border-white/10 bg-slate-800 rounded-xl p-6">
                        <p className="m-0">
                            ...
                            <strong>Email:</strong> <a href="mailto:dpo@inkhaven.in" className="text-teal-600 hover:underline">dpo@inkhaven.in</a><br />
                            <strong>Privacy Email:</strong> <a href="mailto:namamicreations@zenithcryptoai.in" className="text-teal-600 hover:underline">namamicreations@zenithcryptoai.in</a><br />
                ...
                <section className="mb-10">
                    ...
                    <div className="grid gap-4 mt-6">
                        <div className="bg-emerald-50 bg-emerald-950/30 rounded-xl p-5">
                            <h4 className="font-semibold text-emerald-800 text-emerald-200 m-0 mb-2">Contract Performance (Article 6(1)(b))</h4>
                        ...
                        <div className="bg-blue-50 bg-blue-950/30 rounded-xl p-5">
                            <h4 className="font-semibold text-blue-800 text-blue-200 m-0 mb-2">Legitimate Interest (Article 6(1)(f))</h4>
                            <p className="m-0 text-sm">Processing for platform security, abuse prevention, service improvement, and analytics.</p>
                        </div>

                        <div className="bg-violet-50 bg-violet-950/30 rounded-xl p-5">
                            <h4 className="font-semibold text-violet-800 text-violet-200 m-0 mb-2">Consent (Article 6(1)(a))</h4>
                            <p className="m-0 text-sm">Optional processing such as marketing communications and enhanced analytics.</p>
                        </div>

                        <div className="bg-amber-50 bg-amber-950/30 rounded-xl p-5">
                            <h4 className="font-semibold text-amber-800 text-amber-200 m-0 mb-2">Legal Obligation (Article 6(1)(c))</h4>
                ...
                <section className="mb-10">
                    ...
                    <div className="grid gap-4 mt-6 md:grid-cols-2">
                        <div className="border border-slate-200 border-slate-700 rounded-xl p-5">
                ...
                <section className="mb-10">
                    ...
                    <ol className="list-decimal pl-6 space-y-2">
                        <li>Email us at <a href="mailto:namamicreations@zenithcryptoai.in" className="text-teal-600 hover:underline">namamicreations@zenithcryptoai.in</a></li>
                    ...
                    <div className="bg-blue-50 bg-blue-950/30 border-l-4 border-blue-500 p-4 my-4">
                        <p className="m-0">
                    ...
                    <table className="w-full border-collapse border border-slate-300 border-slate-700 mt-4">
                        <thead>
                            <tr className="bg-slate-950/40 backdrop-blur-2xl border border-white/10 bg-slate-800">
                                <th className="border border-slate-300 border-slate-700 px-4 py-2 text-left">Data Type</th>
                                <th className="border border-slate-300 border-slate-700 px-4 py-2 text-left">Retention Period</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Chat Messages</td>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">24 hours (ephemeral default)</td>
                            </tr>
                            <tr className="bg-slate-950/60 backdrop-blur-3xl border border-white/20 bg-slate-800/50">
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Profile Data</td>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Until deletion or 12 months inactivity</td>
                            </tr>
                            <tr>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Moderation Logs</td>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">90 days</td>
                            </tr>
                            <tr className="bg-slate-950/60 backdrop-blur-3xl border border-white/20 bg-slate-800/50">
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Support Tickets</td>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">2 years</td>
                            </tr>
                            <tr>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Payment Records</td>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">7 years (legal requirement)</td>
                            </tr>
                        </tbody>
                    </table>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <div className="bg-slate-950/40 backdrop-blur-2xl border border-white/10 bg-slate-800 rounded-xl p-6">
                        <p className="m-0">
                            ...
                            InkHaven<br />
                            Email: <a href="mailto:dpo@inkhaven.in" className="text-teal-600 hover:underline">dpo@inkhaven.in</a>
                        </p>
                    </div>
                </section>
                ...
                <div className="mt-12 pt-8 border-t border-slate-200 border-slate-700">
                    ...
                    <Link href="/legal/cookies" className="text-teal-600 hover:underline">Cookie Policy</Link>
                </div>
            </div>
        </div>
    );
