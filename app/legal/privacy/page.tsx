    ...
    return (
        <div className="container mx-auto px-6 py-12 max-w-4xl">
            <div className="prose prose-slate max-w-none">
                ...
                <div className="bg-gradient-to-r from-teal-50 to-emerald-50 from-teal-950/30 to-emerald-950/30 rounded-2xl p-6 mb-8">
                ...
                <section className="mb-10">
                    ...
                    <p>
                        InkHaven (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) operates the InkHaven anonymous chat platform at <Link href="https://www.inkhaven.in" className="text-teal-600 hover:underline">www.inkhaven.in</Link>. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Service.
                    </p>
                    <p>
                ...
                <section className="mb-10">
                    ...
                    <p>
                        ...
                        Email: <a href="mailto:namamicreations@zenithcryptoai.in" className="text-teal-600 hover:underline">namamicreations@zenithcryptoai.in</a><br />
                        Support: <a href="mailto:namamicreations@zenithcryptoai.in" className="text-teal-600 hover:underline">namamicreations@zenithcryptoai.in</a>
                    </p>
                </section>
                    ...
                    <table className="w-full border-collapse border border-slate-300 border-slate-700 mt-4">
                        <thead>
                            <tr className="bg-slate-950/40 backdrop-blur-2xl border border-white/10 bg-slate-800">
                                ...
                                <th className="border border-slate-300 border-slate-700 px-4 py-2 text-left">Legal Basis</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Providing our Service</td>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Contract performance</td>
                            </tr>
                            <tr className="bg-slate-950/60 backdrop-blur-3xl border border-white/20 bg-slate-800/50">
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Safety & Security</td>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Legitimate interest</td>
                            </tr>
                            <tr>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Analytics & Improvement</td>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Legitimate interest / Consent</td>
                            </tr>
                            <tr className="bg-slate-950/60 backdrop-blur-3xl border border-white/20 bg-slate-800/50">
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Legal Obligations</td>
                                <td className="border border-slate-300 border-slate-700 px-4 py-2">Legal requirement</td>
                            </tr>
                        </tbody>
                    </table>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <p className="mt-4">
                        To exercise these rights, contact us at <a href="mailto:namamicreations@zenithcryptoai.in" className="text-teal-600 hover:underline">namamicreations@zenithcryptoai.in</a>. We will respond within 30 days.
                    </p>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <div className="bg-slate-950/40 backdrop-blur-2xl border border-white/10 bg-slate-800 rounded-xl p-6">
                        <p className="m-0">
                            <strong>Privacy Inquiries:</strong> <a href="mailto:namamicreations@zenithcryptoai.in" className="text-teal-600 hover:underline">namamicreations@zenithcryptoai.in</a><br />
                            <strong>General Support:</strong> <a href="mailto:namamicreations@zenithcryptoai.in" className="text-teal-600 hover:underline">namamicreations@zenithcryptoai.in</a><br />
