    ...
    <div className="flex items-center gap-3">
        ...
        {showText && (
            <div className="flex flex-col leading-tight">
                <span className="font-bold text-xl tracking-tight text-gray-100 dark:text-white">InkHaven</span>
                <span className="text-[10px] uppercase tracking-widest text-teal-500/60 dark:text-teal-200/60 font-medium">Anonymous Sanctuary</span>
            </div>
        )}
    </div>
);
